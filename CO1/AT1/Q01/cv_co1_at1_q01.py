# -*- coding: utf-8 -*-
"""CV-CO1-AT1-QO1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1JKZrn-iMWh4KzEJjVHTvfulWeB1Gd3I4
"""
...
print("Image Shape:", img.shape)               # Outputs (height, width, channels) e.g., (100, 400, 3)# Downsample the image to a tiny 50x25 resolution to simulate a very low sampling rate (bad camera sensor)
...
plt.axis('off')                                                        # Hide axis ticks and coordinates
plt.show()                                     # Render both subplots to the screen# Define a list of different resolutions to test (Low, Medium, High)
...
plt.show()                                     # Display the final comparison# Start with a heavily downsampled (blurred) low-resolution image
...
plt.show()                                     # Display the corrected images side-by-side# PSNR = Peak Signal-to-Noise Ratio. It mathematically compares a degraded image to the original. Higher dB is better!
